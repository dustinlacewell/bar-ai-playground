# Your First AI Module

Let's build a minimal AI from scratch. This will teach you the structure and how the framework loads your code.
...
That's it. Save this as `luarules/gadgets/ai/comp/bots/my_first_ai.lua`, restart the game, select "Dev AI: my_first_ai" in Skirmish, and you'll see the message in the console.

**What's happening:**
- `local M = {}` creates an empty table (your module).
- `function M.Init(teamID)` defines a function that runs once at game start.
- `Spring.Echo(...)` prints to the console and infolog.
- `return M` returns your module so the framework can call your functions.

## Adding Unit Tracking
...
- **Next:** Read "The Game Loop and Timing" to understand frame rates and throttling better.
- **Then:** Read "Understanding Units" to learn how to categorize and filter units.
- **Advanced:** Read "Giving Orders to Units" to learn all the commands available.
